  ...
  function($scope, $rootScope, $state, $stateParams, MockService,
    ...
    var Popup1 = $ionicPopup.show({
        template: '<div class="list">'+
                    ...
                    '<ion-toggle ng-model="airplaneMode" toggle-class="toggle-possitive">'+
                        '<i class="icon ion-toggle-filled"></i>Notifications</ion-toggle>'+
                    '<a href="#" class="item item-icon-left">'+
                        '<i class="icon ion-person"></i> Account & Profile</a></div>',
        title: '<b>SETTINGS</b>',
...
function getMockMessages() {
  return {"messages":[
      ...
      {"_id":"54781ca4ab43d1d4113abff1",
       ...
       "read":true,
       "readDate":"2014-12-01T06:27:38.338Z"}],"unread":0};
}
